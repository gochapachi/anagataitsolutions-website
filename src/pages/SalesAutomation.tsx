  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <Badge variant="secondary" className="mb-4">Sales Automation Pricing</Badge>
            <h2 className="text-3xl font-bold mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card>
              <CardHeader className="text-center">
                <CardTitle>Sales Starter</CardTitle>
                <CardDescription>Basic automation for small teams</CardDescription>
                <div className="text-3xl font-bold mt-4">₹12,000<span className="text-lg font-normal">/month</span></div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center p-3 bg-muted/50 rounded">
                  <div className="font-semibold text-sm">Best for: 2-5 sales reps</div>
                </div>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Pipeline management</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Follow-up automation</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Basic reporting</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Email integration</li>
                </ul>
            ...
            <Card className="border-primary ring-2 ring-primary">
              <CardHeader className="text-center">
                ...
                <CardDescription>Complete sales automation</CardDescription>
                <div className="text-3xl font-bold mt-4">₹20,000<span className="text-lg font-normal">/month</span></div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center p-3 bg-primary/5 rounded">
                  <div className="font-semibold text-sm text-primary">Best for: 5-15 sales reps</div>
                </div>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Everything in Starter</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Proposal automation</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Advanced analytics</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Meeting scheduling</li>
            ...
            <Card>
              <CardHeader className="text-center">
                ...
                <div className="text-3xl font-bold mt-4">₹35,000<span className="text-lg font-normal">/month</span></div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center p-3 bg-muted/50 rounded">
                  <div className="font-semibold text-sm">Best for: 15+ sales reps</div>
                </div>
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Advanced forecasting</li>
