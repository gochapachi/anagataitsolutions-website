  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl font-bold mb-4">
                Real Results from {caseStudy.company}
              </h2>
            </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="p-4 bg-primary/5 rounded-lg border border-primary/20">
                  ...
                  <cite className="text-sm font-medium text-primary">- {caseStudy.founder}</cite>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <Badge variant="secondary" className="mb-4">Marketing Automation Pricing</Badge>
            <h2 className="text-3xl font-bold mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card>
              <CardHeader className="text-center">
                ...
                <div className="text-3xl font-bold mt-4">₹15,000<span className="text-lg font-normal">/month</span></div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center p-3 bg-muted/50 rounded">
                  <div className="font-semibold text-sm">Best for: 5-20 employees</div>
                </div>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Email automation</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Lead capture forms</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Basic CRM integration</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Up to 1,000 contacts</li>
                </ul>
            ...
            <Card className="border-primary ring-2 ring-primary">
              <CardHeader className="text-center">
                ...
                <div className="text-3xl font-bold mt-4">₹25,000<span className="text-lg font-normal">/month</span></div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center p-3 bg-primary/5 rounded">
                  <div className="font-semibold text-sm text-primary">Best for: 20-50 employees</div>
                </div>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Everything in Starter</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />AI lead scoring</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Social media automation</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Content generation</li>
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Up to 5,000 contacts</li>
                </ul>
                <Button className="w-full">Start Free Trial</Button>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="text-center">
                <CardTitle>Marketing Enterprise</CardTitle>
                <CardDescription>Advanced automation + custom features</CardDescription>
                <div className="text-3xl font-bold mt-4">₹40,000<span className="text-lg font-normal">/month</span></div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center p-3 bg-muted/50 rounded">
                  <div className="font-semibold text-sm">Best for: 50+ employees</div>
                </div>
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Unlimited contacts</li>
                </ul>
