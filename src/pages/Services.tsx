...
const Services = () => {
  const services = [{
    ...
    features: ["AI-powered lead qualification and scoring", "Automated email sequences and nurturing", "Social media scheduling and engagement", "Content generation and optimization", "Landing page creation and A/B testing", "Analytics and ROI tracking"],
    benefits: ["Save 20+ hours per week on marketing tasks", "Increase lead conversion by 300%", "Generate consistent, quality content", "Never miss a follow-up again"],
    ...
    features: ["CRM integration and automation", "Sales pipeline management", "Automated proposal generation", "Follow-up sequence automation", "Deal tracking and forecasting", "Sales team performance analytics"],
    benefits: ["Reduce sales cycle by 40%", "Increase deal closure rate by 60%", "Automate 80% of administrative tasks", "Never lose track of prospects"],
    ...
    features: ["Automated job posting across platforms", "AI-powered candidate screening", "Digital onboarding workflows", "Employee database management", "Attendance and leave tracking", "Performance review automation"],
    benefits: ["Reduce hiring time by 50%", "Save ₹2.5L annually on recruitment", "Improve employee satisfaction by 40%", "Ensure compliance automatically"],
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="space-y-16">
            {services.map((service, index) => <div key={index} className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                {/* Content */}
